  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={clsx(
        ...
        'bg-white dark:bg-slate-900 shadow-lg duration-200 rounded-lg border border-border-light',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={clsx(
      'mt-2 sm:mt-0 inline-flex h-10 items-center justify-center rounded-lg px-4 py-2 text-sm font-medium',
      'border border-border-light bg-white hover:bg-gray-50 text-text-primary',
