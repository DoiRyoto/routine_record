    ...
    <ScrollArea className="h-96 w-80 rounded-md border">
      <div className="p-4">
        ...
        <div className="space-y-3">
          {[
            { date: '2024-03-20', time: '07:00', mission: '朝のジョギング', value: '30分' },
            { date: '2024-03-20', time: '08:30', mission: '英語学習', value: '25分' },
            { date: '2024-03-20', time: '12:15', mission: '読書', value: '20分' },
            { date: '2024-03-19', time: '07:15', mission: '朝のジョギング', value: '32分' },
            { date: '2024-03-19', time: '09:00', mission: '瞑想', value: '15分' },
            { date: '2024-03-19', time: '20:30', mission: '筋力トレーニング', value: '40分' },
            { date: '2024-03-18', time: '07:30', mission: '朝のジョギング', value: '28分' },
            { date: '2024-03-18', time: '21:00', mission: '日記を書く', value: '10分' },
            { date: '2024-03-17', time: '06:45', mission: '朝のジョギング', value: '35分' },
            { date: '2024-03-17', time: '19:15', mission: '楽器の練習', value: '45分' },
            { date: '2024-03-16', time: '08:00', mission: '英語学習', value: '30分' },
            { date: '2024-03-16', time: '13:30', mission: 'プログラミング学習', value: '60分' },
          ].map((entry, index) => (
