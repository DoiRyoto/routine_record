...
import type { StreakData } from '@/components/gamification';
...
export function StreakDisplay({
  ...
  if (variant === 'compact') {
    return (
      <div className={`inline-flex items-center bg-orange dark:bg-dark-orange text-orange dark:text-orange rounded-full font-medium ${sizeClasses[size]} ${className}`} data-testid="streak-counter">
